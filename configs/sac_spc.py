...
def get_config():
    ...
    config.dict_configs.alpha = 1e-2                              # unadjustable
    ...
    config.actor_configs.hidden_dims = (1024, 1024, 1024, 1024)   # unadjustable
    config.actor_configs.name_activation = 'relu'                 # unadjustable
    ...
    config.critic_configs.name_activation = 'relu'                # unadjustable
